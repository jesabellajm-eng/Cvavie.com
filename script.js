...
const FR_EN = {
  ...
  'Le calcul est simple':'The math is simple','Ici : 23,99 $ une fois.':'Here: $23.99 once.','Ailleurs : jusqu’à 30 $/mois.':'Elsewhere: up to $30/month.','La concurrence facture une nouvelle fois le mois suivant. Nous, non.':'Other builders charge you again next month. We do not.',
  ...
  'Payez une seule fois — accès à vie, sans aucun abonnement caché derrière une offre à 2 $.': 'Pay once — lifetime access, with no hidden subscription behind a $2 offer.',
  '💎 Zéro abonnement caché': '💎 Zero hidden subscription',
  'Payez une seule fois': 'Pay just once',
  'Téléchargements illimités': 'Unlimited downloads',
  'Fini les faux essais à 2 $': 'No more fake $2 trials',
  ...
  'Toutes les réponses pour aborder votre rédaction de CV en toute sérénité, sans mauvaise surprise ni abonnement caché.':'Every answer you need to write your resume with total peace of mind — no bad surprises, no hidden subscription.',
  'Oui, absolument et sans aucune exception.':'Yes, absolutely — no exceptions.',
  'Vous ne réglez que 23,99 $ une seule fois pour débloquer votre accès complet à vie. Aucun renouvellement automatique, aucune facturation mensuelle récurrente et aucun frais surprise. Que vous reveniez modifier votre CV dans trois mois, un an ou cinq ans, vous ne paierez plus jamais rien.':'You pay $23.99 only once to unlock your full lifetime access. No automatic renewal, no recurring monthly billing, no surprise fees. Whether you come back to edit your resume in three months, one year or five years, you will never pay anything again.',
  'PIÈGE DE L\'INDUSTRIE':'INDUSTRY TRAP',
  'C’est le piège d\'abonnement le plus répandu sur le web':'This is the most common subscription trap on the web',
  ', souvent appelé le « faux essai à 2 $ ». Ces sites attirent les candidats avec un prix d\'appel trompeur de 1,95 $ ou 2,95 $ pour télécharger un premier document, mais leurs conditions dissimulent un abonnement récurrent de':', often called the "fake $2 trial". These sites lure candidates with a deceptive $1.95 or $2.95 teaser price to download a first document, but their terms hide a recurring subscription of',
  '30 $ à 50 $ prélevé chaque mois':'$30 to $50 charged every month',
  'sur votre carte bancaire.':'to your credit card.',
  'Chez':'At',
  ...
  'Nos modèles garantissent : texte vectoriel sélectionnable et indexable, polices typographiques professionnelles reconnues, hiérarchie de titres standardisée et zéro élément graphique perturbateur pouvant bloquer l\'analyse algorithmique.':'Our templates guarantee: selectable, indexable real text, recognized professional typefaces, a standardized heading hierarchy, and zero disruptive graphic elements that could block algorithmic parsing.',
  'Que comprend exactement mon accès à vie à 23,99 $ sur CVavie.com ?':'What exactly does my $23.99 lifetime access on CVavie.com include?',
  'Votre achat de 23,99 $ comprend un accès illimité et perpétuel à l\'ensemble de la plateforme :':'Your $23.99 purchase includes unlimited, perpetual access to the entire platform:',
  'Accès complet aux 8 modèles professionnels (Quill, Atlas, Meridian, Lumen, Harbor, Vector, Cadence, North)':'Full access to all 8 professional templates (Quill, Atlas, Meridian, Lumen, Harbor, Vector, Cadence, North)',
  'Palette de 8 couleurs d\'accent interchangeables':'A palette of 8 interchangeable accent colors',
  'Optimisation de texte par IA illimitée et gratuite':'Unlimited, free AI text optimization',
  'Téléchargements PDF haute définition sans restriction':'Unrestricted high-resolution PDF downloads',
  'Mises à jour et modifications futures de votre CV pour toute votre carrière':'Future updates and edits to your resume for your entire career',
  'Aucun mot de passe requis.':'No password required.',
  'Votre travail est continuellement sauvegardé en direct dans votre navigateur web. De plus, votre adresse courriel fait office de clé unique : grâce au bouton « Connexion / Accès client » situé en haut du site, vous pouvez recharger instantanément votre CV sauvegardé et votre statut payé à vie depuis n\'importe quel appareil.':'Your work is continuously saved live in your web browser. Plus, your email address acts as your unique key: with the "Client Login / Access" button at the top of the site, you can instantly reload your saved resume and lifetime paid status from any device.',
  'Oui, absolument et en un seul clic.':'Yes, absolutely — in a single click.',
  'Toutes les informations que vous avez saisies (coordonnées, profil, expériences, formations, compétences, langues) restent conservées lorsque vous basculez entre les 8 modèles ou changez la couleur d’accent.':'All the information you entered (contact details, profile, experiences, education, skills, languages) is preserved when you switch between the 8 templates or change the accent color.',
  'Le règlement est 100 % sécurisé et chiffré de bout en bout par Stripe':'Payment is 100% secure and encrypted end-to-end by Stripe',
  ', le leader mondial du paiement en ligne. Nous acceptons les cartes Visa, Mastercard, American Express ainsi qu\'Apple Pay et Google Pay.':', the world leader in online payments. We accept Visa, Mastercard, American Express, as well as Apple Pay and Google Pay.',
  'Nous n’avons jamais accès à vos numéros de carte bancaire et aucune reconduction n’est possible.':'We never have access to your credit card numbers, and no rebilling is possible.',
  'Il est rattaché à l\'adresse courriel utilisée lors de votre achat, et non à votre appareil.':'It is tied to the email address used at checkout, not to your device.',
  'tout est déjà là. Votre CV et votre accès payé sont conservés automatiquement, même des mois plus tard. Vous n\'avez rien à faire.':'everything is already there. Your resume and your paid access are kept automatically, even months later. You have nothing to do.',
  'cliquez simplement sur le bouton « Connexion / Accès client » en haut du site, saisissez l\'adresse courriel de votre achat, et votre accès à vie est immédiatement restauré. Vous pouvez alors télécharger de nouveau votre PDF sans repayer.':'simply click the "Client Login / Access" button at the top of the site, enter the email address from your purchase, and your lifetime access is instantly restored. You can then download your PDF again without paying twice.',
  'Un conseil pratique : conservez le courriel de confirmation envoyé par Stripe après votre paiement, il vous rappelle l\'adresse exacte à utiliser. Et par prudence, gardez toujours une copie du PDF téléchargé dans vos courriels ou votre espace de stockage personnel.':'A practical tip: keep the confirmation email Stripe sends after your payment — it reminds you of the exact address to use. And as a precaution, always keep a copy of your downloaded PDF in your emails or personal storage.',
};
